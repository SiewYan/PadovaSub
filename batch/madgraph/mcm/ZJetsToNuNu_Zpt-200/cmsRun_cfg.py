...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-01910-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJetsToNuNu_Zpt-200_1111111.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJetsToNuNu_Zpt-200_1111111_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/ZJetsToNuNu_Zpt-200/v1/ZJetsToNuNu_Zpt-200_tarball.tar.xz', 
        'false', 
        'slc6_amd64_gcc530', 
        'CMSSW_7_1_25_patch1'),
